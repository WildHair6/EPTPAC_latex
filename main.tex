...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.55\linewidth]{fig/Case1_Results_ErrorNorms_tf120.0.pdf}
    \caption{Case~1: Log-scale error norms and prescribed-accuracy bounds.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.55\linewidth]{fig/qe_norm_comparison.pdf}
  \caption{Case~2: MRP error norm for different $T_f$}
  \label{fig:Case2_qe_norm}
\end{figure}

Fig.~\ref{fig:Case2_qe_norm} shows that the attitude tracking error converges at the respective prescribed terminal times for all tested values,
...
In summary, Case~2 validates the exact prescribed-time convergence and prescribed-accuracy tunability through sweeps of $T_f$ and $\varepsilon_1$, respectively.
...
\begin{figure}[ht]
    \centering
    \begin{minipage}[b]{0.43\linewidth}\centering
        \includegraphics[width=\linewidth]{fig/PTC_compare_Attitude__t_total400.0_eptpac.pdf}\\[2pt]
        \footnotesize (a) Attitude error
    \end{minipage}
    \hspace{0.05\linewidth}
    \begin{minipage}[b]{0.43\linewidth}\centering
        \includegraphics[width=\linewidth]{fig/PTC_compare_ControlTorque_t_total400.0_eptpac.pdf}\\[2pt]
        \footnotesize (b) Control torque
    \end{minipage}
    \caption{Case 3.1: Torque-only saturation with $T_f=300$ s}
    \label{fig:case4_1_tf300}
\end{figure}

Fig.~\ref{fig:case4_1_tf300} shows that for $T_f=300~\si{s}$, Ref.~\cite{xu_distributed_2022} converges around $150~\si{s}$, exhibiting pronounced conservatism at only 50\% of the prescribed maneuver duration.

\begin{figure}[ht]
    \centering
    \begin{minipage}[b]{0.43\linewidth}\centering
        \includegraphics[width=\linewidth]{fig/PTC_compare_Attitude__t_total300.0_eptpac.pdf}\\[2pt]
        \footnotesize (a) Attitude error
    \end{minipage}
    \hspace{0.05\linewidth}
    \begin{minipage}[b]{0.43\linewidth}\centering
        \includegraphics[width=\linewidth]{fig/PTC_compare_ControlTorque_t_total300.0_eptpac.pdf}\\[2pt]
        \footnotesize (b) Control torque
    \end{minipage}
    \caption{Case 3.1: Torque-only saturation with $T_f=150$ s}
    \label{fig:case4_1_tf150}
\end{figure}

However, when $T_f$ is reduced to $150~\si{s}$, the prescribed-time convergence no longer holds.
Fig.~\ref{fig:case4_1_tf150} shows that the response does not converge at $150~\si{s}$ but is instead delayed to approximately $230~\si{s}$.
...
\begin{figure}[ht]
    \centering
    \begin{minipage}[b]{0.43\linewidth}\centering
        \includegraphics[width=\linewidth]{fig/PTC_compare_Attitude__t_total500.0_eptpac.pdf}\\[2pt]
        \footnotesize (a) Attitude error
    \end{minipage}
    \hspace{0.04\linewidth}
    \begin{minipage}[b]{0.43\linewidth}\centering
        \includegraphics[width=\linewidth]{fig/PTC_compare_omega__t_total500.0_eptpac.pdf}\\[2pt]
        \footnotesize (b) Angular velocity error
    \end{minipage}\\[1pt]
    \begin{minipage}[b]{0.43\linewidth}\centering
        \includegraphics[width=\linewidth]{fig/PTC_compare_ControlTorque_t_total500.0_eptpac.pdf}\\[2pt]
        \footnotesize (c) Control torque
    \end{minipage}
    \hspace{0.04\linewidth}
    \begin{minipage}[b]{0.43\linewidth}\centering
        \includegraphics[width=\linewidth]{fig/PTC_compare_WheelMomentum_t_total500.0_eptpac.pdf}\\[2pt]
...
Numerical simulations validated the effectiveness of the proposed framework in achieving exact terminal-time convergence, tunable accuracy, and dual-saturation compliance.
