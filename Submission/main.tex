...
entering the prescribed accuracy only $0.24$--$0.25~\si{s}$ prior to $T_f$.
...
\begin{figure}[ht]
    \centering
    \subfloat[Attitude error ($T_f=300$ s)]{\includegraphics[width=0.4\linewidth]{PTC_compare_Attitude__t_total400.0.pdf}\label{fig:err300}}
    \hspace{0.05\linewidth}
    \subfloat[Control torque ($T_f=300$ s)]{\includegraphics[width=0.4\linewidth]{PTC_compare_ControlTorque_t_total400.0.pdf}\label{fig:tau300}}
    \\[-6pt]
    \subfloat[Attitude error ($T_f=150$ s)]{\includegraphics[width=0.4\linewidth]{PTC_compare_Attitude__t_total300.0.pdf}\label{fig:err150}}
    \hspace{0.05\linewidth}
    \subfloat[Control torque ($T_f=150$ s)]{\includegraphics[width=0.4\linewidth]{PTC_compare_ControlTorque_t_total300.0.pdf}\label{fig:tau150}}
...
\begin{figure}[ht]
    \centering
    \subfloat[Attitude error]{\includegraphics[width=0.4\linewidth]{PTC_compare_Attitude__t_total500.0.pdf}\label{fig:err_dual}}
    \hspace{0.05\linewidth}
    \subfloat[Angular velocity error]{\includegraphics[width=0.4\linewidth]{PTC_compare_omega__t_total500.0.pdf}\label{fig:omega_dual}}
    \\[-6pt]
    \subfloat[Control torque]{\includegraphics[width=0.4\linewidth]{PTC_compare_ControlTorque_t_total500.0.pdf}\label{fig:tau_dual}}
    \hspace{0.05\linewidth}
    \subfloat[Wheel momentum]{\includegraphics[width=0.4\linewidth]{PTC_compare_WheelMomentum_t_total500.0.pdf}\label{fig:hw_dual}}
