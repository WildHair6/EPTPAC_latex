JOURNAL OF GUIDANCE, CONTROL, AND DYNAMICS Vol. 44, No. 2, February 2021 
...
*Ph.D. Candidate, Institute of Space Systems, Hermann-Blenk-Strasse 23; juntang.yang@tu-braunschweig.de. 

- †Graduate Student, Faculty of Mechanical Engineering; y.duan@tu- 

- braunschweig.de. 

- ‡ResearchAssociate,InstituteofSpaceSystems,Hermann-Blenk-Strasse23; 

- m.ben-larbi@tu-braunschweig.de. 

- §Professor,InstituteofSpaceSystems,Hermann-Blenk-Strasse23;e.stoll@ 
...
J. GUIDANCE, VOL. 44, NO. 2: ENGINEERING NOTES 
...
**==> picture [241 x 200] intentionally omitted <==**
...
**----- Start of picture text -----**<br>
a) The value of 12 q [T] MF q b) The value of 12 q [T] MM q<br>**----- End of picture text -----**<br>
...
**----- Start of picture text -----**<br>
a) Error quaternion<br>**----- End of picture text -----**<br>


**==> picture [151 x 8] intentionally omitted <==**

**----- Start of picture text -----**<br>
b) Vector part of error quaternion (zoom in)<br>**----- End of picture text -----**<br>


**==> picture [445 x 202] intentionally omitted <==**

**----- Start of picture text -----**<br>
c) Angular velocity d) Angular velocity (zoom in)<br>e) Control torque f) Energy cost<br>**----- End of picture text -----**<br>
...
**==> picture [437 x 173] intentionally omitted <==**
